...
public abstract class PLAPullToRefreshAdapterViewBase<T extends PLA_ListView> extends
    ...
    public PLAPullToRefreshAdapterViewBase(Context context) {
        super(context);
        mRefreshableView.setOnScrollListener(this);
    }

    public PLAPullToRefreshAdapterViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRefreshableView.setOnScrollListener(this);
    }

    public PLAPullToRefreshAdapterViewBase(Context context, Mode mode) {
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }

    public PLAPullToRefreshAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle) {
    ...
    public final void onScroll(final PLA_AbsListView view, final int firstVisibleItem,
